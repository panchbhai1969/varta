...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='BANKNAME',
            field=models.CharField(verbose_name='BANK NAME', null=True, blank=True, max_length=50),
        ),
        migrations.AlterField(
            model_name='paytmhistory',
            name='BANKTXNID',
            field=models.IntegerField(verbose_name='BANK TXN ID', null=True, blank=True),
        ),
        migrations.AlterField(
            model_name='paytmhistory',
            name='CURRENCY',
            field=models.CharField(verbose_name='CURRENCY', null=True, blank=True, max_length=4),
        ),
        migrations.AlterField(
            model_name='paytmhistory',
            name='GATEWAYNAME',
            field=models.CharField(verbose_name='GATEWAY NAME', null=True, blank=True, max_length=30),
        ),
        migrations.AlterField(
            model_name='paytmhistory',
            name='ORDERID',
        ...
        migrations.AlterField(
            model_name='paytmhistory',
            name='PAYMENTMODE',
            field=models.CharField(verbose_name='PAYMENT MODE', null=True, blank=True, max_length=10),
        ),
        migrations.AlterField(
            model_name='paytmhistory',
            name='RESPCODE',
