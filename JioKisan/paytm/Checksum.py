...
__unpad__ = lambda s: s[0:-ord(str(s[-1])[0])]
...
# if __name__ == "__main__":
    ...
    # params = {         "MID": "sNUXVx29909317083112",         "ORDER_ID": "order123",         "CUST_ID": "cust123",         "TXN_AMOUNT": "1.00",         "CHANNEL_ID": "WEB",         "INDUSTRY_TYPE_ID": "Retail",         "WEBSITE": "DEFAULT"     }